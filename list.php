...
<?php
  ...
  echo "&nbsp;<a href=\"#\" onClick=\"MyWindow=window.open('upload.php','MyWindow','width=900,height=380'); return false;\" title=\"Uploader un fichier IGC pour créer/mettre à jour un vol\"><img src=\"upload.svg\" width=\"32px\"></a>";
