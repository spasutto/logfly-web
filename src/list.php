...
<?php
  ...
  foreach ($vols->vols as $vol)
  {
    ...
    if ($vol->igc) {
      ...
      $url = "trace.html?igc=".$tracefileprefix.".igc&start=".$vol->date->getTimestamp()."&duration=".$vol->duree."&finfo=".$tracefileprefix.".json&paraglidername=".urlencode($vol->voile)."&clegeoportail=".(defined('CLEGEOPORTAIL')?urlencode(CLEGEOPORTAIL):"");
