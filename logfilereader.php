...
require("logfileutils.php");
	...
	class LogflyReader
	{
		...
		function getRecords($id=null, $tritemps = FALSE, $datemin=null, $datemax=null, $voile=null, $site=null)
		{
		  ...
		  $unvol = FALSE;
			...
			$vols->vols = array();
			$sql = "SELECT * from VOL LEFT JOIN SITE ON V_Site=S_Nom";
			$cond = "1=1";
			...
			while($row = $ret->fetchArray(SQLITE3_ASSOC))
			{
				...
				$vols->vols[] = $vol;
				$vols->tempstotalvol += intval($row['V_Duree']);
